 ...
 * Метод на вход принимает количество сантиметров. Нужно
 * сделать так, чтобы метод возвращал число полных метров
 * в centimetre. (1 метр = 100 см).
 ...
 2
 */
public class FullLengthPainting {
